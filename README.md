...
URL Shortener API — сервис сокращения ссылок на FastAPI. Пользователь может создать короткую ссылку для длинного URL, использовать кастомный alias, задать срок жизни ссылки, получать статистику переходов, искать ссылку по исходному URL и управлять своими ссылками после регистрации.
...
Во всех примерах ниже локальный адрес сервиса:
...
### 3. Создание короткой ссылки без кастомного alias
...
### 4. Создание короткой ссылки с alias и сроком жизни
